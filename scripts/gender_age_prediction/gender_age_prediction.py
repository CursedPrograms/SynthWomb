...
def main():
    ...
    scripts = {
        "1": {
            ...
            "description": "Predict gender from an image",
            "file_name": "gender_predictor.py"
        },
        "2": {
            "name": "Run 'gender_predictor_output.py",
            "description": "Predict gender from an image with output",
            "file_name": "gender_predictor_output.py"
        },
        "3": {
            "name": "Run 'gender_age_predictor_output.py",
            "description": "Predict gender and age from an image with output",
            "file_name": "gender_age_predictor_output.py"
        },
        "4": {
            "name": "Run 'gender_age_predictor_feed.py",
            "description": "Predict gender and age from an webcam feed",
            "file_name": "gender_age_predictor_feed.py"
        },
    }
