...
def main():
    ...
    scripts = {
        "1": {
            ...
            "description": "Run the GPT",
            "file_name": "transformer.py"
        },
        "2": {
            "name": "Run 'Run 'transformer_t2s.py",
            "description": "Run GPT with text-to-speech",
            "file_name": "transformer_t2s.py"
        },
        "3": {
            "name": "Run 'Run 'transformer_s2t2s.py",
            "description": "Run GPT with speech-text-to-speech",
            "file_name": "transformer_s2t2s.py"
        },
        "4": {
            "name": "Run 'Run 'transformer_webcam.py",
            "description": "Run GPT with webcam and microphone input",
            "file_name": "transformer_webcam.py"
        },
    }
