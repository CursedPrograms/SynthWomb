...
def main():
    ...
    scripts = {
        "1": {
            "name": "Run 'image_detect_face.py'",
            "description": "Detect a face from an image",
            "file_name": "image_detect_face.py"
        },
        "2": {
            "name": "Run 'feed_detect_face.py",
            "description": "Detect a face from a webcam feed",
            "file_name": "feed_detect_face.py"
        },
    }
